...
# import the dataset
dataset_df = pd.read_csv('data/dataset_disease_prediction.csv')
...
clean_df.to_csv('data/clean_dataset_disease_prediction.tsv', sep='\t', index=False)
...
model.save_model("model/model_disease_prediction.json")